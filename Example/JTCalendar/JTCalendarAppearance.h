...
// dql
@property (strong, nonatomic) UIColor *feastTextColor;
@property (strong, nonatomic) UIColor *feastTextColorSelected;
@property (strong, nonatomic) UIColor *feastTextColorOtherMonth;
@property (strong, nonatomic) UIColor *feastTextColorSelectedOtherMonth;
@property (strong, nonatomic) UIColor *feastTextColorToday;
@property (strong, nonatomic) UIColor *feastTextColorTodayOtherMonth;
